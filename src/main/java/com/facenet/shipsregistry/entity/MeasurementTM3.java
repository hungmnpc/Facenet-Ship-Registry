...
//
//    @OneToOne(cascade = {CascadeType.MERGE, CascadeType.PERSIST})
//    @JoinColumn(name = "1st_frame_no_TM3")
//    private DetailMeasurement firstFrameNoTM3;
//
//    @OneToOne(cascade = {CascadeType.MERGE, CascadeType.PERSIST})
//    @JoinColumn(name = "2nd_frame_no_TM3")
//    private DetailMeasurement secondFrameNoTM3;
//
//    @OneToOne(cascade = {CascadeType.MERGE, CascadeType.PERSIST})
//    @JoinColumn(name = "3rd_frame_no_TM3")
//    private DetailMeasurement thirdFrameNoTM3;
//}
